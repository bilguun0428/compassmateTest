Ext.define('Compassmate.view.map.Map', {
    extend: 'Compassmate.view.map.BaseMap',
    xtype: 'mapView',

    requires: [
        'Compassmate.view.map.MapController',
        'Compassmate.view.SettingsMenu',
...
//            fieldLabel: Strings.mapLayer,
        	...
        	xtype: 'textfield',
        	//handler: 'showSearch',
        	reference: 'showSearch',
        	fieldlabel: 'Координатаар хайх',
        	emptyText: 'Уртраг , Өргөрөг',
        	...
        	stateId: 'settings-geofences-button',
        }, {    	
            hidden: true,

...
Ext.define('Compassmate.DeviceImages', {
    singleton: true,
    ...
    getImageSvg: function (color, zoom, angle, category) {
        ...
        if (zoom) {
            width *= Compassmate.Style.mapScaleSelected;
            height *= Compassmate.Style.mapScaleSelected;
            scaleTransform = 'scale(' + Compassmate.Style.mapScaleSelected + ') ';
        } else {
            width *= Compassmate.Style.mapScaleNormal;
            height *= Compassmate.Style.mapScaleNormal;
            scaleTransform = 'scale(' + Compassmate.Style.mapScaleNormal + ') ';
        }

...
Ext.define('Compassmate.store.CoordinateFormats', {
    ...
    formatValue: function (key, value, unit) {
        ...
        switch (unit) {
            case 'ddm':
                ...
                return degrees + '° ' + minutes.toFixed(Compassmate.Style.coordinatePrecision) + '\' ' + hemisphere;
            case 'dms':
                value = Math.abs(value);
                degrees = Math.floor(value);
            ...
            default:
                return value.toFixed(Compassmate.Style.coordinatePrecision) + '°';
        }
    }
});

...
public class DateUtilTest {
    ...
    public void testCorrectDate() throws ParseException {
        ...
        Assert.assertEquals(f.parse("2017-11-22 00:00:00"),
                DateUtil.getNextDate(f.parse("2017-11-21 00:00:00")));

        Assert.assertEquals(f.parse("2017-11-22 00:00:00"),
                DateUtil.getNextDate(f.parse("2017-11-21 23:59:59")));

        Assert.assertEquals(f.parse("2017-11-22 23:59:59"),
                DateUtil.getEndOfDate(f.parse("2017-11-22 13:00:11")));

        Assert.assertEquals("Thursday",
                DateUtil.getWeekDayName(f.parse("2017-11-30 00:00:00")));

        Assert.assertEquals("Thursday",
                DateUtil.getWeekDayName(f.parse("2017-11-30 23:59:59")));
    }

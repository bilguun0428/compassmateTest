...
public class Position extends Message {
    ...
    public static final String KEY_FUEL_ADD = "fueladd";
    ...
    public static final String KEY_FUEL_CHARGED = "chargedFuel"; // liters
    ...
    //
    public static final String ALARM_FUEL_ADD = "fueladd";
    public static final String ALARM_DOOR_PRESSED = "pressed";
    public static final String ALARM_DOOR_UNPRESSED = "unpressed";

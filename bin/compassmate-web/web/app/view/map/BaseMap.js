...
Ext.define('Compassmate.view.map.BaseMap', {
    ...
    initMap: function () {
        var layer, type, lat, lon, zoom, maxZoom, target;

        type = Compassmate.app.getPreference('map', null);

        layer = this.getLayer(type)

        lat = Compassmate.app.getPreference('latitude', Compassmate.Style.mapDefaultLat);
        lon = Compassmate.app.getPreference('longitude', Compassmate.Style.mapDefaultLon);
        zoom = Compassmate.app.getPreference('zoom', Compassmate.Style.mapDefaultZoom);
        maxZoom = Compassmate.app.getAttributePreference('web.maxZoom', Compassmate.Style.mapMaxZoom);
        ...
        switch (Compassmate.app.getPreference('distanceUnit', 'km')) {
            case 'mi':
    ...
    getLayer: function(type) {
    	var layer, server, bingKey;
    	server = Compassmate.app.getServer();

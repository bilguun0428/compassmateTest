...
//            dialog.lookupReference('toDateContainerField').setFieldLabel(Strings.reportWhen);
        }
    ...
    updateButtons: function () {
        ...
        this.lookupReference('showButton').setDisabled(reportType === 'daily' || disabled);
    ...
    onTypeChange: function (combobox, newValue, oldValue) {
	    ...
	    this.getGrid().reconfigure('ReportDaily', this.summaryColumns);
	    this.getView().getLayout().setActiveItem('grid');
	}

...
Ext.define('Compassmate.view.edit.DevicesController', {
    extend: 'Compassmate.view.edit.ToolbarController',
    alias: 'controller.devices',

    requires: [
        'Compassmate.view.dialog.Command',
        'Compassmate.view.dialog.Device',
        'Compassmate.view.permissions.DeviceGeofences',
        'Compassmate.view.permissions.DeviceAttributes',
        'Compassmate.view.permissions.DeviceDrivers',
        'Compassmate.view.BaseWindow',
        'Compassmate.model.Device',
        'Compassmate.model.Command'
    ],
    ...
    objectModel: 'Compassmate.model.Device',
    objectDialog: 'Compassmate.view.dialog.Device',
    removeTitle: Strings.sharedDevice,

    init: function () {
        var self = this, readonly, deviceReadonly;
        deviceReadonly = Compassmate.app.getPreference('deviceReadonly', false) && !Compassmate.app.getUser().get('admin');
        readonly = Compassmate.app.getPreference('readonly', false) && !Compassmate.app.getUser().get('admin');
        ...
        }, Compassmate.Style.refreshPeriod);
    },
    ...
    onCommandClick: function () {
        ...
        command = Ext.create('Compassmate.model.Command');
        command.set('deviceId', deviceId);
        command.set('textChannel', !online);

        dialog = Ext.create('Compassmate.view.dialog.Command');
...
//      this.lookupReference('deviceCommandButton').setDisabled(empty || readonly);
    ...
    export: function (event, target, options) {
        var exportTask = {
            zip: new JSZip(),
            xlsTitle: options.name || this.xlsTitle,
        ...
        var cols = this.getView().down('headercontainer').getGridColumns();
